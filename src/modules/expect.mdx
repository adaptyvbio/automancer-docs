...
This module can be used with the `expect:` state attribute. For example, to ensure that a given temperature sensor readout stays at more than 30ºC, use the following.
