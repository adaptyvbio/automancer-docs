...
1. Back to the experiment settings in {Brand}, you can check that points were recorded. The points are saved in the experiment settings and will be recovered when restarting {Brand}.
