...
<PagePreviews pages={[
  ...
  { title: 'Tutorial – Add support for new devices',
    ...
    url: './devices' },
  { title: 'Tutorial – Create a timer process',
    description: 'Recreate the timer process to understand how processes work.',
    url: './timer-process' },
  { title: 'Developing plugins',
    description: 'Understand what a plugin is and how to develop one.',
    url: './plugins' },
  { title: 'Developing processes',
    description: 'Learn how to develop processes.',
    url: './processes' }
]} />
